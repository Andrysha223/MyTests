...
// Реальные коды украинских мобильных операторов — сайт валидирует номер
// именно по этому списку ("Вказуйте лише номери мобільних операторів України").
...
export interface RandomContactDetails {
  ...
  firstName: string;
  patronymic: string;
  // 9 цифр без ведущего "0" — маска "+38 (0__) ___-__-__" сама подставляет
  // фиксированный "0", вводить его не нужно (см. CheckoutPage.fillContactDetails).
  phone: string;
  email: string;
}

...
// Ціна товару (1 902 ₴) сама по собі вища за поріг безкоштовної доставки Нової
// Пошти (freeShippingMinPrice: 1700 ₴ у відповіді API) — тому однієї штуки
// достатньо, докуповувати кількість не потрібно.
...
// Перевіряє безкоштовну доставку у відділення «Нова Пошта» при сумі
// замовлення від 1700 ₴ (freeShippingMinPrice у відповіді
// GET /api/v1/basket/delivery): логін -> очищення кошика -> додавання
// дорогого товару (LEGO Marvel Шолом Залізної Людини, 1902 ₴, вище порогу) ->
// контактні дані заповнені акаунтом -> вибір способу доставки "Нова
